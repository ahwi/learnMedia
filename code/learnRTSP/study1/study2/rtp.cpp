...
int rtpSendPacketOverUdp(int clientSockfd, const char* ip, uint16_t port, struct RtpPacket* rtpPacket, uint32_t dataSize)
{
    ...
    ret = sendto(clientSockfd, (const char *)rtpPacket, dataSize+RTP_HEADER_SIZE, 0, 
